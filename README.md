...
## Team:
- **Alvarez Leon Luis Arturo**
- **Bermudez Lopez Karol Alexa**
- **Castaneda Robledo Fatima Guadalupe**
- **Nolasco Ayala Javier Alejandro**

## Programs:
- **`grades.cpp`:** Gets the grades of the user and checks if the user scored at least 50% in every grading parameter, and if the user attended at least 80% of their classes, if so, the program prints the final grade.
- **`factorial.cpp`:** User enters a whole number and the program prints its factorial using while and for.
- **`average.cpp`:** The user inputs two limits of an interval and the program takes the whole numbers within the interval, including the limits, and prints the average.
